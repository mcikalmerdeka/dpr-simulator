...
LATAR BELAKANG:
Desa Cikadu di Cianjur Selatan memiliki 3 sekolah dasar (SD) dan 1 SMP dengan total 850 siswa. Namun, kondisi pendidikan digital di desa ini sangat memprihatinkan. Jaringan internet tidak stabil (sering hilang sinyal), hanya ada 1 laboratorium komputer usang dengan 5 komputer yang masih menyala (berbagi untuk 850 siswa), dan guru-guru belum mendapatkan pelatihan teknologi yang memadai.

DATA & FAKTA PERMASALAHAN:
- Rasio komputer vs siswa: 1 komputer untuk 170 siswa (Sangat buruk)
- Kecepatan internet rata-rata: < 2 Mbps (Sering putus)
- 85% siswa kelas 6 SD belum pernah menggunakan laptop/komputer
- Guru tidak bisa mengakses platform Merdeka Mengajar karena kendala sinyal
- Anak-anak tertinggal jauh dalam literasi digital dibanding kota besar

SOLUSI YANG DIUSULKAN MASYARAKAT:
1. Pembangunan menara BTS/penguat sinyal 4G di titik strategis desa
2. Pengadaan 50 unit laptop/Chromebook untuk laboratorium komputer sekolah
3. Instalasi internet satelit (Starlink/VSAT) sebagai backup
4. Pelatihan literasi digital rutin untuk 35 guru di desa tersebut
5. Program "Satu Siswa Satu Tablet" untuk kelas 5-6 SD dan SMP

TARGET YANG DIHARAPKAN:
- 100% siswa lulus SD sudah melek teknologi dasar
- Guru bisa menggunakan metode pembelajaran digital interaktif
- Akses informasi pendidikan setara dengan kota besar
- Meningkatkan nilai Asesmen Kompetensi Minimum (AKM) siswa

PIHAK YANG PERLU DILIBATKAN:
- Kementerian Komunikasi dan Informatika (Bakti Kominfo)
- Kementerian Pendidikan, Kebudayaan, Riset, dan Teknologi
- Dinas Pendidikan Kabupaten Cianjur
- Komisi X dan Komisi I DPR RI"""

ASPIRATION_2 = """Kualitas Layanan RSUD Dr. Soegiri yang Buruk di Lamongan, Jawa Timur

LATAR BELAKANG:
RSUD Dr. Soegiri sebagai rumah sakit rujukan utama di Kabupaten Lamongan menerima keluhan terus-menerus dari masyarakat terkait antrean BPJS yang membludak (rata-rata 4-6 jam), kekurangan dokter spesialis (terutama onkologi dan jantung), serta fasilitas rawat inap kelas 3 yang kelebihan kapasitas (pasien sering dirawat di lorong).

DATA & FAKTA PERMASALAHAN:
- Waktu tunggu antrean obat BPJS: Rata-rata 4 jam
- Rasio Bed Occupancy Rate (BOR) Kelas 3: Mencapai 110% (Overload)
- Kekurangan dokter spesialis: Hanya ada 1 Onkolog untuk populasi 1.3 juta
- Alat CT-Scan sering rusak dan waktu perbaikan lama (2-3 bulan)
- 35% pasien rujukan terpaksa dirujuk lagi ke Surabaya karena alat tidak lengkap
- Ruang tunggu sempit, panas, dan tidak manusiawi bagi lansia

SOLUSI YANG DIUSULKAN MASYARAKAT:
1. Implementasi sistem antrean online BPJS yang terintegrasi penuh (Mobile JKN)
2. Penambahan gedung rawat inap baru khusus kelas 3 (kapasitas +100 bed)
3. Rekrutmen dan insentif khusus untuk menarik dokter spesialis langka
4. Peremajaan alat kesehatan vital (MRI baru, CT-Scan cadangan)
5. Perluasan ruang tunggu dan perbaikan sistem ventilasi/AC

TARGET YANG DIHARAPKAN:
- Waktu tunggu pasien BPJS maksimal 1 jam
- Tidak ada lagi pasien yang dirawat di lorong RS
- Pasien bisa ditangani tuntas di Lamongan tanpa perlu ke Surabaya
- Kepuasan masyarakat terhadap RSUD meningkat >85%

PIHAK YANG PERLU DILIBATKAN:
- Kementerian Kesehatan RI
- Dinas Kesehatan Provinsi Jawa Timur
- Manajemen RSUD Dr. Soegiri
- BPJS Kesehatan Cabang Lamongan
- Komisi IX DPR RI"""
...
- Kepolisian Daerah Riau (Polda)
- Perusahaan Perkebunan Sawit (CSR dan tanggung jawab hukum)
- Komisi IV DPR RI"""
